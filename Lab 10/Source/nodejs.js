...
var app = express();
var result={'body': []};
var url = 'mongodb://lab10:lab10@ds057476.mlab.com:57476/lab10';
//mongodb://<dbuser>:<dbpassword>@ds057476.mlab.com:57476/sriharsha
app.use(cors());
...
app.post('/register', function (req, res) {
    ...
    var insertDocument = function(db, data, callback) {
        db.collection('myase').insertOne( data, function(err, result) {
            if(err)           {
...
app.post('/get-data',function (req,res) {
    ...
    var findUser = function(db, callback) {
        var cursor =db.collection('myase').find();
...
app.post('/update',function (req,res) {
    ...
    var updateDocument = function(db, data, callback) {
        db.collection('myase').updateOne({"_id":ObjectId(id)},{$set:item}, function(err, result) {
            if(err)            {
                res.write("Registration Failed");
                res.end();            }
...
app.post('/delete', function(req, res) {
    ...
    MongoClient.connect(url, function(err, db) {
        if(err)        {
            res.write("Registration Failed");
            res.end();        }
        db.collection('myase').deleteOne({"_id": ObjectId(id)}, function(err, result) {
