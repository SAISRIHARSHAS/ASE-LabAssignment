...
app.get('/getdata/:id', function (req, res) {
    ...
    request('https://restcountries.eu/rest/v1/name/'+req.params.id, function (error,response,body) {
        ...
        request('http://api.openweathermap.org/data/2.5/weather?lat='+lat+'&lon='+lang+'&appid=1c1672978dfe09a51c283f1b050e83b5&units=metric', function (error, response, body1) {
