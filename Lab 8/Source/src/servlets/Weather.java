...
//		response.getWriter().append("Served at: ").append(request.getContextPath());
	...
	public static String[] callWeatherAPI(String location){
		String myURL="http://api.openweathermap.org/data/2.5/weather?q="+location+"&appid=a677cee39061b39ee41e564a0807d994";
		System.out.println("Requeted URL:" + "http://api.openweathermap.org/data/2.5/weather?q=chicago&appid=a677cee39061b39ee41e564a0807d994");
		StringBuilder sb = new StringBuilder();
		URLConnection urlConn = null;
		InputStreamReader in = null;
		try {
